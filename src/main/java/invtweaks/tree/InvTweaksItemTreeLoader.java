...
public class InvTweaksItemTreeLoader extends DefaultHandler {
    ...
    public synchronized static InvTweaksItemTree load( File file) throws Exception {
        ...
        InvTweaksMod.LOGGER.info("Starting Loading Tree.");
        ...
        InvTweaksMod.LOGGER.info("Finished Loading Tree.  Highest Order: " + tree.getHighestOrder());
    ...
    public synchronized void startElement(String uri, String localName, String name,  Attributes attributes)
        ...
        if(id != null) {
            ...
            if(extraDataAttr != null) {
                try {
                    extraData = TagParser.parseTag(extraDataAttr);
                } catch(Exception e) {
            ...
            if(extraDataAttr != null) {
                try {
                    extraData = TagParser.parseTag(extraDataAttr.toLowerCase());
                } catch(Exception e) {
                    throw new RuntimeException("Data attribute failed for tree entry '" + name + "'", e);
                }
            }
    ...
    public void warning(SAXParseException e) throws SAXException {
    	InvTweaksMod.LOGGER.warn("Tree XML Warning: ", e);
    }

    @Override
    public void error(SAXParseException e) throws SAXException {
    	InvTweaksMod.LOGGER.error("Tree XML Error: ", e);
    }

    @Override
    public void fatalError(SAXParseException e) throws SAXException {
    	InvTweaksMod.LOGGER.fatal("Tree XML Fatal Error: ", e);
    }
